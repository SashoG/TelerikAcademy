...
namespace _11.PolynomialSumation
{
    class PolynomialSumation
    {
        ...
        static decimal[] ArraySubstraction(decimal[] Array1, decimal[] Array2)
        {
        ...
        static decimal[] ArrayMultiplication(decimal[] Array1, decimal[] Array2)
        {
            //decimal[] smallerArr;
            //decimal[] biggerArr;
            ...
            //if (Array1.Length>Array2.Length)
            //{
            //    Array1.CopyTo(biggerArr);
            //    Array2.CopyTo(smallerArr);
            //}
            //else
            //{
            //    Array2.CopyTo(biggerArr);
            //    Array1.CopyTo(smallerArr);
            //}
            decimal[] result = new decimal[Array1.Length+Array2.Length];
            for (int index1 = 0; index1 < Array1.Length; index1++)
            {
                for (int index2 = 0; index2 < Array2.Length; index2++)
                {
                    result[index1+index2] += Array1[index2] * Array2[index1];
                }
            }
            return result;
        ...
        static void Main(string[] args)
        {
            ...
            Console.Write("{0,-20}","1 Polynom: ");
            PrintPolynom(polynom1);
            
            Console.Write("{0,-20}", "2 Polynom: ");
            PrintPolynom(polynom2);
            
            decimal[] resultSum = ArraySum(polynom1, polynom2);
            Console.Write("{0,-20}", "Sumation: ");
            PrintPolynom(resultSum);
            
            decimal[] resultSubstraction = ArraySubstraction(polynom1, polynom2);
            Console.Write("{0,-20}", "Substraction(1-2): ");
            PrintPolynom(resultSubstraction);
            
            decimal[] resultMultiply = ArrayMultiplication(polynom1, polynom2);
            Console.Write("{0,-20}", "Multiplication: ");
            PrintPolynom(resultMultiply);
